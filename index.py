...
def generate_image_flux(prompt):
    """Genera imagen con FLUX Kontext Pro"""
...
def save_to_notion(text, message_type):
    """Guarda en base de datos de Notion"""
    db_map = {
        "task": TASKS_DB_ID,
        "note": NOTES_DB_ID,
        "idea": IDEAS_DB_ID,
        "client": CLIENTS_DB_ID
    }
...
💬 O simplemente chatea conmigo 🚀"""
    
    elif command == "/help":
        return """📖 **Guía:**

**Comandos:**
• /task Llamar a cliente - Guarda en Notion
• /note Ideas landing - Guarda nota
• /idea App delivery - Guarda idea
• /client María - 555-1234 - Guarda cliente
• /image Logo café - Genera con FLUX
...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        html = f"""
        <html>
        <head><title>Bot Activo</title><meta charset="utf-8"></head>
